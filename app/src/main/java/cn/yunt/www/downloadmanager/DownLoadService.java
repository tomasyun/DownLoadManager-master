...
import cn.yunt.www.downloadmanager.fileload.ApiStore;
import cn.yunt.www.downloadmanager.fileload.FileCallback;
import cn.yunt.www.downloadmanager.fileload.FileResponseBody;
...
public class DownLoadService extends Service {
    ...
    public void loadFile() {
        ...
        retrofit.baseUrl(ApiStore.API_SERVER_URL)
                .client(initOkHttpClient()).build()
                .create(ApiStore.class).loadFile()
